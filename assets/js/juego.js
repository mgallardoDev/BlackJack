...
const contenedoresPuntuacion = document.querySelectorAll('.jugador__puntos');
...
const inicializarJuego = () => {
     ...
     contenedoresCartas.forEach((contenedor) => (contenedor.innerHTML = ''));
     contenedoresPuntuacion.forEach((contenedor) => (contenedor.innerText = 0));
     puntuaciones = [0, 0];
};
